...
\begin{equation}
t^*=(W-w_i)\,V'(\mN)\,\frac{\Neff}{N}\,\mu'(a),\quad V'(\mN)=\frac{2\sigma^2\mN}{(1-\mN^2)^2},
\end{equation}
and a per-unit fee $t^*$ on aggressiveness makes the decentralized equilibrium coincide with the symmetric social optimum.
\end{theorem}

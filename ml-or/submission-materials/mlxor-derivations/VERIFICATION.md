...
**Run: 2026-08-30, `python verify/verify_all.py` (numpy 2.4.6). Result:
38/38 checks passed.** The complete run log ships as
...
| V9.1 | T9 pointwise domination on `[-2/c, inf)`, strict failure below (D3 sec. 5) | 3 curvatures, 4e5-pt grids |
| V9.2 | T9 witness ratio = 50-digit value; collapse rate `delta^2` (D3 sec. 5) | 0.8516504722; slope 2.00 |
| V9.3 | T9: 20000 random within-reach designs never beat the floor (D3 sec. 5) | min ratio 1.0366 |
| V9.4 | T9 jet-Jacobian det `= C1 c^2 e^{-2ch}` (D3 sec. 5) | 9 cells, rel. err < 1e-9 |

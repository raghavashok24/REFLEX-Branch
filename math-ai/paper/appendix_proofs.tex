...
rate of Theorem \ref{thm:exchange}, in the exact pathwise form
(Theorem \ref{thm:t2exact}), and the two-sided structure-proofness result
of Theorem \ref{thm:reach} (Theorem \ref{thm:t9full}). Both proofs are
